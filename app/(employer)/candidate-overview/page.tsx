...
// Applicants are fetched from the applications-for-job forwarder via the useGetApplicationsForJob hook.
// We'll map the API response into the Applicant[] shape used by this component.
...
export default function TalentMatching() {
  ...
  // Map the API response into the Applicant[] shape (safe access without `any`)
  ...
  // When fetched applicants arrive, select the first one by default
  useEffect(() => {
  ...
  // Dynamic style mappings to replace Tailwind classes
                  ...
                  <div style={{ display: "flex", alignItems: "start", justifyContent: "space-between" }}>
                    ...
                    <button
                      onClick={async () => {
                        ...
                        // payload expected: { message, application, aiEvaluation }
                        if (payload && payload.application) {
                          ...
                          // update selectedApplicant with returned values
